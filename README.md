...
- griddemo-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- griddemo-ui: main application module, development time
- griddemo-production: module that produces a production mode WAR for deployment
